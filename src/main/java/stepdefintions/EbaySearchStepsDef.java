...
public class EbaySearchStepsDef {
    WebDriver driver;
    ...
    @When("user searches for iMac {int}")
    public void user_searches_for_i_mac(Integer int1) {
    ...
    public void there_are_more_than_pages_of_results(Integer expextedPages) {
        List<WebElement> allpages= driver.findElements(By.xpath("//ol[@class='pagination__items']//li"));

            Assert.assertTrue(allpages.size()>expextedPages);
